...
@ComponentScan(basePackages = "beenthere.dao beenthere.service beenthere.utility")
@PropertySource(value="beenthere/resources/configuration.properties")
public class SpringConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUsername("T562888");
		dataSource.setPassword("T562888");
		return dataSource;
	}
	...
	public LocalSessionFactoryBean getSessionFactory(DataSource dataSource) {
		 ...
		 * sessionFactoryBean
		 */
		sessionFactoryBean.setPackagesToScan("beenthere.entity");
